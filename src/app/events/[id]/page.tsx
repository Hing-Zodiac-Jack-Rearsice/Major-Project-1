      ...
      <Card className="overflow-hidden shadow-lg">
        <div className="relative h-96">
          ...
          <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end">
            <h1 className="text-4xl font-bold text-black dark:text-white">{event.eventName}</h1>
            <ShareEventButtons event={event} className="bg-white/10 hover:bg-white/20 text-white" />
          </div>
        </div>
