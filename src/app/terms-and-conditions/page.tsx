...
const TermsAndConditions = () => {
  return (
    <div className="container mx-auto p-4 pt-16">
      ...
      <h2 className="text-2xl font-semibold mb-2">3. Technical Issues</h2>
      <p className="mb-4">
        If you encounter any technical issues while using our website, please contact our support team at [your contact email or phone number]. We will make reasonable efforts to resolve technical problems promptly but do not guarantee uninterrupted access to the website.
      </p>
      
      <h2 className="text-2xl font-semibold mb-2">4. Payment and Ticket Sales</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mb-2">5. Refunds and Cancellations</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        If you have any questions about these terms and conditions, please contact us at [your contact email or phone number].
      </p>
    </div>
  );
};
